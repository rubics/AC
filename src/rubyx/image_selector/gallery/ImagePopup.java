...
public class ImagePopup extends PopupScreen{
	
	Screen this_screen;
	public TabbedButton uploadButton;
	TabbedButton cancelButton;
	
	public ImagePopup(Bitmap image){
...
//		addKeyListener(new PopupKeyListener(this));
		...
		uploadButton = new TabbedButton("Upload", 6);
		cancelButton = new TabbedButton("Cancel", 6);
		cancelButton.setChangeListener(AirCrewApp.backButtonListener);
