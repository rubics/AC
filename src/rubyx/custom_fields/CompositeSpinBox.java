...
public class CompositeSpinBox extends Manager implements CompositeField{
	...
	private CustomSpinBox spinBox;
	
	public CompositeSpinBox(String _label, Object[] choices, String placeholder, int _style){
		super(0);
		drawstyle = _style;
		labelField = new LabelField(_label, 0);
		labelField.setFont(font_composite_label);
		spinBox = new CustomSpinBox(choices, placeholder);
		labelField.setFont(font_composite_label);
		add(labelField);
		add(spinBox);
	}
