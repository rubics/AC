...
public class UpdateRosterRequest implements HttpRequestListener {
	
	private static final String method = "POST";
	private HttpRequestListener requestListener = this;
	private HttpRequestDispatcher dispatcher;
	
	public UpdateRosterRequest(){}
	
	public void updateRoster(String postString){
		System.out.println(postString);
		dispatcher = new HttpRequestDispatcher(AirCrew.update_roster, method, requestListener, postString);
		dispatcher.start();
	}
