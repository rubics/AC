...
public abstract class ClearChatHistoryRequest implements HttpRequestListener {
	...
	public void clearChatHistory(){
		dispatcher = new HttpRequestDispatcher(AirCrew.clear_chat_history + AirCrewApp.app.getUserController().getUser().getUserId(), method, requestListener, "");
		dispatcher.start();
	}
