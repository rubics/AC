...
public class DeleteImageRequest implements HttpRequestListener {
	...
	public void deleteImage(String image_id){
		dispatcher = new HttpRequestDispatcher(AirCrew.delete_image + image_id, method, requestListener, "");
		dispatcher.start();
	}
